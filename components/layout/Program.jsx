...
export default function Program() {
  const isBeforeTablet = useMediaQuery({ maxWidth: 1023 });
  const isFromDesktop = useMediaQuery({ minWidth: 1024 });
  return (
    <section>
        ...
        <div className="page__sections">
          ...
          {isBeforeTablet && (
            <ul className={s.program__list}>
              ...
              <li className={s.program__item}>
                <span className={s.program__num}>2.</span> ВИВЧЕННЯ ТЕОРІЇ.
                Зручна система вивчення теоретичної частини дозволяє навчатися
                як у класі, так і онлайн, а також можливість самостійного
                проходження теоретичної частини під керівництвом викладача
              </li>
              <li className={s.program__item}>
                <span className={s.program__num}>3.</span> САМОСТІЙНА
                ПІДГОТОВКА. Безкоштовний доступ до проходження курсу самостійної
                підготовки водіїв pdr.auto-tsou.com (рекомендується для
              ...
              <li className={s.program__item}>
                ...
                Найбільш ефективний спосіб навчання це закріплення теорії
                спільно з практикою в місті, що дозволяє набагато швидше освоїти
                нові знання
              </li>
              <li className={s.program__item}>
              ...
              <li className={s.program__item}>
                ...
                Складаєте іспит теорії для отримання прав категорії
                безпосередньо в ДАІ
              </li>
              <li className={s.program__item}>
          ...
          {isFromDesktop && (
            <div>
              <div className={s.program__tree}>
                <ul>
                  <li className={s.item__line}></li>
                  <li className={s.item__line}></li>
                  <li className={s.item__line}></li>
                  <li className={s.item__line}></li>
                  <li className={s.item__line}></li>
              ...
              <ul className={s.program__list}>
                <li className={s.program__item}>
                  ЗАПИС В АВТОШКОЛУ. Записатися в нашу автошколу за телефоном
                  або прийти та оформити все на місці
                </li>
                <li className={s.program__item}>
                  ВИВЧЕННЯ ТЕОРІЇ. Зручна система вивчення теоретичної частини
                  дозволяє навчатися як у класі, так і онлайн, а також
                  можливість самостійного проходження теоретичної частини під
                  керівництвом викладача
                </li>
                <li className={s.program__item}>
                  САМОСТІЙНА ПІДГОТОВКА. Безкоштовний доступ до проходження
                  курсу самостійної підготовки водіїв pdr.auto-tsou.com
                  (рекомендується для слухачів, що періодично пропускають
                  заняття для самостійного опрацювання пропущених тем)
                </li>
                <li className={s.program__item}>
                ...
                <li className={s.program__item}>
                  ...
                  перевіряємо теорію та практику водіння, що дозволяє Вам
                  впевнено скласти іспит в ДАІ
                </li>
                <li className={s.program__item}>
                ...
                <li className={s.program__item}>
                  ІСПИТ З ПРАКТИЧНОГО ВОДІННЯ В ДАІ. Складаєте практичний іспит
                  на майданчику
                </li>
                <li className={s.program__item}>
